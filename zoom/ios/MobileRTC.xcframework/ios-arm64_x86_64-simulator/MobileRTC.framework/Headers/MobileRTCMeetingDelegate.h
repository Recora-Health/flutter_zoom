 ...
 * @note DisplayName A name to be displayed in the meeting, password The meeting passcode, cancel If YES, the attempt to join the meeting is cancelled.
 */
...
/**
 * @brief Sink the event that lets participants share a new white board.
...
/**
 * @brief Sink the event that lets participants allow to share.
 * @param allow YES allow.if NO.participants may not share.
 */
- (void)onAllowParticipantsShareStatusNotification:(BOOL)allow;
/**
 * @brief Sink the event that allow a meeting lock status change.
 ...
 * @param featuresArr The AI features that can't be turned off. see \link MobileRTCAICompanionType \endlink.
 */
