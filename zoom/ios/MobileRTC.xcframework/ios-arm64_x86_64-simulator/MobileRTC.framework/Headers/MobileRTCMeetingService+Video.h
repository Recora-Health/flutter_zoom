 ...
 * @param userId The ID of the user whose video is being checked.
 * @return Indicates if it is able to pin.
 */
 ...
 * @return If the function succeeds, it will return @c Errors_Success.
 ...
 * @note A. mode is "MobileRTCAutoFramingMode_CenterCoordinates", 1~10. b. mode is "MobileRTCAutoFramingMode_FaceRecognition", 0.1~10.
 */
- (MobileRTCSDKError)setVideoAutoFramingRatio:(CGFloat)ratio;

/**
 * @brief Set the fail strategy of face recognition when auto-framing is enabled(mode is " @c MobileRTCAutoFramingMode_FaceRecognition").
