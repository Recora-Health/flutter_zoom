...
class MethodChannelZoom extends ZoomPlatform {
  ...
  Future<bool> startMeeting(ZoomMeetingOptions options) async {
    ...
    return channel.invokeMethod<bool>('start', optionMap).then<bool>((bool? value) => value ?? false);
  }
  ...
  Future<List> meetingStatus() async {
    return channel.invokeMethod<List>('meeting_status').then<List>((List? value) => value ?? List.empty());
  }
  ...
  Future<void> leaveMeeting() async {
    return await channel.invokeMethod<void>('leave', {});
  }
}
